# -*- coding: utf-8 -*-
"""infy assignment4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WeIQaWGGBGiWiLO4TId4jIvkcOS1pIsb
"""
...
class Occasional_customer(Customer):
    __counter=1000
    def __init__(self,customer_name,distance_in_kms):
        self.__bill_id=bill_id
        self.__customer_name=customer_name
        self.__distance_in_kms=distance_in_kms
        bill_id="O"+str(random.randint(1001,2001))
...
class Regular_customer(Customer):
    ...
    def __init__(self,customer_name,no_of_tiffin):
        ...
        bill_id="R"+str(random.randint(101,201))
    ...
    def calculate_bill_amount(self):
        if(validate_no_of_tiffin()):
            bill_amount=50*self.__no_of_tiffin
        else:
            bill_amount=-1
